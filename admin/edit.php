    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center">Edit Doctors Info</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <form method="post">
                                ...
                                <input type="number" name="salary" class="form-control" placeholder="Enter Doctor's salary" value="<?php echo $row['salary'] ?>">
