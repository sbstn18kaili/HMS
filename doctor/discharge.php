                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                                if (isset($_POST['send'])) {
                                    ...
                                    $invoice_query = "INSERT INTO invoices (appointment_id, fee, description) VALUES ('$id', '$fee', '$description')";
                                    if (mysqli_query($connect, $query)) {
                                        echo "<p class='alert alert-success'>Invoice sent successfully!</p>";
                                    } else {
                                        echo "<p class='alert alert-danger'>Error sending invoice!</p>";
