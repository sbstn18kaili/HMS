...
include("../include/connection.php"); // Include your connection file here if needed
?>
                            ...
                            <div class="col-md-3 my-2 bg-warning mx-2" style="height:150px;">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        ?>
                                            <h5 class="text-white" style="font-size:30px;">
                                                <?php echo $pp;  ?>
                                            </h5>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            ?>
                                            <h5 class="text-white my-2" style="font-size:30px;"><?php echo $appoint; ?>
                                            </h5>
                                            <h5 class="text-white">Total</h5>
